<template>
    <div id="id1" style=" width:1300px ;height:680px;"></div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted(){
             $axios.getAna10().then(res => {
                for(var i=0;i<res.data.length;i++)
                {
                    data[i].name=res.data[i].name;
                    data[i].value=res.data[i].value;
                }
                for(var i=0;i<res.data.length;i++)
                {
                    data[i].name=res.data[i].name;
                    this.$set(geoCoordMap, res.data[i].name, [res.data[i].lng,res.data[i].lat])
                }
